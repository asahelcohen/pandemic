...
namespace pandemic
{
    ...
    Board::Board()
    {
        ...
        DiscoveredCures = {{Color::Black, false}, {Color::Blue, false}, {Color::Red, false}, {Color::Yellow, false}};
