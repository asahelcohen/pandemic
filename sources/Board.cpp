...
namespace pandemic
{
    map<City, set<City>> Board::cityMap = {{City::Algiers, {City::Madrid, City::Paris, City::Istanbul, City::Cairo}},
    ...
    //     {Color::Blue, false}, {Color::Red, false}, 
    //     {Color::Yellow, false}};
    ...
    {
        // map <City,int> temp = b.cityNum;
        // std::map<City, int>::iterator it = temp.begin();
    ...
    {
        DiscoveredCures.at(Color::Black) = false;
        DiscoveredCures.at(Color::Yellow) = false;
        DiscoveredCures.at(Color::Red) = false;
        DiscoveredCures.at(Color::Blue) = false;
    }
